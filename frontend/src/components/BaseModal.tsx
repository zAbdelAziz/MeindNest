...
const BaseModal: React.FC<BaseModalProps> = ({
	...
	return (
		<div className="fixed inset-0 flex items-center justify-center z-200 bg-neutral-300 dark:bg-neutral-900 text-neutral-800 dark:text-neutral-400 bg-opacity-10">
			<form
				ref={formRef}
